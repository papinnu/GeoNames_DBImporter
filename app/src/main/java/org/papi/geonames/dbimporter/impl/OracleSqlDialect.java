...
public class OracleSqlDialect extends AbstractSqlDialect {
    ...
    private static final String CREATE_STATE = "CREATE TABLE %1$s (ID INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL, %2$s VARCHAR(20) NOT NULL, %3$s VARCHAR(100) NOT NULL, CONSTRAINT PK_%1$s_ID PRIMARY KEY (ID), CONSTRAINT UNI_%1$s_%2$s UNIQUE (%2$s));";
    private static final String CREATE_DEFAULT = "CREATE TABLE %1$s (ID INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL, %2$s INT NOT NULL, %3$s VARCHAR(20) NOT NULL, %4$s VARCHAR(100) NOT NULL, CONSTRAINT PK_%1$s_ID PRIMARY KEY (ID), CONSTRAINT UNI_%1$s_%2$s_%3$s UNIQUE (%2$s, %3$s));";
    private static final String CREATE_CITY = "CREATE TABLE %1$s (ID INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1 INCREMENT BY 1) NOT NULL, stateId INT NOT NULL, countyId INT NOT NULL, %2$s INT, %3$s VARCHAR(20) NOT NULL, %4$s VARCHAR(100) NOT NULL, CONSTRAINT PK_%1$s_ID PRIMARY KEY (ID), CONSTRAINT UNI_%1$s_SC_%3$s UNIQUE (stateId, countyId, %3$s));";
